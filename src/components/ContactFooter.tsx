  ...
  return (
    <footer id="contact" className="bg-muted">
      <div className="container mx-auto px-4 pt-16 pb-8">
        {/* CTA Card */}
        <div className="bg-charcoal rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
          <div>
            <h2 className="font-heading text-2xl md:text-3xl font-bold text-background mb-2">
              Ready to Start Your Journey?
            </h2>
            <p className="text-background/70 font-body text-sm max-w-md">
              Have questions? We're here to help you build your beauty empire. Chat with us directly.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <button
              onClick={() => handleWhatsApp(WHATSAPP_1)}
              className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground hover:bg-rose-gold-dark transition-colors"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              {/* TikTok */}
              <a href="https://www.tiktok.com/@BGORGEOUS" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-foreground/10 flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V8.75a8.18 8.18 0 004.76 1.52V6.84a4.84 4.84 0 01-1-.15z"/>
                </svg>
              </a>
              {/* Instagram */}
              <a href="https://www.instagram.com/BGORGEOUS" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-foreground/10 flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/BGORGEOUS" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-foreground/10 flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
